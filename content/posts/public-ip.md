...
![ip.cn](https://res.cloudinary.com/dspnhl2nc/image/upload/v1678792515/blog/ip_csgxyr.png)

2. **查看路由器或者软路由的 WAN IP。**

由于我家网络是由软路由分发的，所以只需要确实软路由就好了：

![软路由](https://res.cloudinary.com/dspnhl2nc/image/upload/v1678810002/blog/soft-router_fzcm7a.jpg)

如果你是路由器则确认路由器界面：

![路由器](https://res.cloudinary.com/dspnhl2nc/image/upload/v1678810001/blog/router_hvuvib.jpg)
...
![DDNS](https://res.cloudinary.com/dspnhl2nc/image/upload/v1678809524/blog/domain_yyauxn.jpg)
